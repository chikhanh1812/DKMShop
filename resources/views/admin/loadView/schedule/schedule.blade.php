...
<div class="row">
        <div class="col-lg-4 col-sm-12">
                    <div class="card">
                        <div class="card-body">
                            <a class="btn btn-primary btn-block" href="javascript:void(0);">Danh sách email khách hàng</a>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="mail_content">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h3 class="mail_head mb-3">Thiết lập</h3>
                                    </div>
                                    ...
                                    <div class="mail_message col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <label for="example-text-input" class="col-form-label">Tiêu đề</label>
                                            ...
                                            <div class="form-group">  
                                            <label for="example-text-input" class="col-form-label">Nội dung</label>                                            
