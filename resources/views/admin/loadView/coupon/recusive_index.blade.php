                ...
                <div class="col-lg-12 stretched_card mt-4">
                    ...
                    @include('components.alert')
                        <div class="card-body">
                            ...
                            @if($users->can('admin.coupon.create'))
                            <a id="load"  href="{{route('admin.coupon.create')}}" class="btn btn-success float-right">Thêm mã</a>
                            @endif
