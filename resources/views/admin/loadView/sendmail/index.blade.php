...
<div class="col-lg-12 stretched_card mt-4">
                    ...
                    @include('components.alert')                
                            ...
                            <p class="text-danger">Chú ý: Khách hàng sẽ nhận được gmail sau 5 phút từ lúc gửi</p>                      
                                ...
                                <div class="table-responsive">
                                    <table class="table text-center">
                                        ...
                                        <tr class="text-white">
                                            ...
                                            <th >Danh sách mail khách hàng</th>
...
<div class="row">
    <div class="col-sm-6 pt-3">
        <div class="card">
            <div class="card-body">
            <h4>Chọn chương trình giảm giá</h4>
 <div class="select">
   <select name="coupon" >
    ...
    <div class="col-sm-6 pt-3">
        <button class="btn btn-success">Gửi Mail</button>
    </div>
</div>
</form>
@endsection
