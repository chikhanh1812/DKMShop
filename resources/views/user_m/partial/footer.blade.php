        ...
        <div class="row">
            <div class="col-lg-4 col-md-12 col-sm-12 col-12">
                <div class="footer_left_side">
                    ...
                    <p>
                        We always bring you the best, newest, hottes products. Come to our DKM Shop!
                    </p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 col-12">
                <div class="footer_one_widget">
                    ...
                    <ul>
                        ...
                        <li><a href="{{route('viewmainblog')}}">Blog</a></li>
        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="copyright_left">
                    <h6>TDTU <span>DKMShop</span></h6>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-12">
                <div class="copyright_right">
                    <img src="{{asset('assets/img/common/payment.png')}}" alt="img" />
                </div>
            </div>
        </div>
    </div>
